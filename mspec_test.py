'''
@Autuor: MrX.Seven
@Contact: 1500986078@qq.com
@Original Autuor: LZ-CH
...
# test_images
	...
	with torch.no_grad():
		...
		MSPEC_net.load_state_dict(torch.load('./snapshots/MSPECnetexp2.pth'))
		MSPEC_net.eval()
		filedir ='./MultiExposure_dataset/testing/INPUT_IMAGES'
		gtimg_dir = './MultiExposure_dataset/testing/expert_a_testing_set'
